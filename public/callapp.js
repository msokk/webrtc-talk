var CallMap = function() {
  ...
  this.getLocation(function(err, coords) {
    ...
    that.addMarker(socket.socket.sessionid, coords);
...
CallMap.prototype.addMarker = function(id, coords) {
...
CallMap.prototype.getLocation = function(cb) {
  ...
  navigator.geolocation.getCurrentPosition(function(position) {
    cb && cb(null, position.coords);
  }, function(err) {
    cb && cb(err, null);
  });
};

CallMap.prototype.setStatus = function(msg) {
...
CallMap.prototype.call = function(target) {
  var that = this;
  var pc = this.peers[target] = new webkitDeprecatedPeerConnection(
